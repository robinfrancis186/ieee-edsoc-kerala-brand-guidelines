...
export default function BrandGuidelines() {
  ...
  return (
    <div className="flex-1 w-full relative">
      <div className="sticky top-0 z-10 w-full bg-white/80 backdrop-blur-md border-b border-border flex items-center px-8 py-3 gap-2 overflow-x-auto hidden">
        {/* Can use a top nav for page sections if desired, keeping it clean for now */}
      </div>
      ...
      {/* Section Nav */}
      <div className="px-16 py-4 bg-white border-b sticky top-0 z-20 flex gap-6 overflow-x-auto">
        {PAGE_NAV_ITEMS.map((item) => (
          <button
            key={item.id}
            onClick={() => scrollTo(item.id)}
            className="text-sm font-semibold transition-colors whitespace-nowrap outline-none"
            style={{
              color: activeNav === item.id ? BRAND.colors.orange : BRAND.colors.midGray,
              borderBottom: activeNav === item.id ? `2px solid ${BRAND.colors.orange}` : "2px solid transparent",
              paddingBottom: "8px"
            }}
          >
            {item.label}
              ...
              <div className="flex gap-6 mt-4 flex-wrap">
                {[
                  ...
                  <div key={w.weight} className="text-center">
                    <p className="text-2xl" style={{ fontWeight: w.weight as any, color: BRAND.colors.navy }}>Ag</p>
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-3 gap-6">
              <MockupCard bg="white" label="Primary — Light Background">
                <img src="/ieee-logo-colour.png" alt="Logo" className="w-40" />
              </MockupCard>
              <MockupCard bg={BRAND.colors.navyDark} label="Primary — Dark Background">
                <img src="/ieee-logo-white.png" alt="Logo" className="w-40" />
              </MockupCard>
            ...
            >
              ...
              <div className="flex items-center gap-8">
                ...
                >
                  <img src="/ieee-logo-colour.png" alt="Logo" className="w-32" />
                  <div
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="rounded-2xl overflow-hidden shadow-md">
                ...
                >
                  <img src="/ieee-logo-white.png" alt="Logo" className="h-10" />
            ...
            <div>
              ...
              >
                <img src="/ieee-logo-colour.png" alt="Logo" className="h-20" />
                <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div
                  className="rounded-2xl p-8 flex flex-col justify-between"
                  style={{
                    background: BRAND.colors.lightGray,
                    minHeight: 260,
                    aspectRatio: "1/1",
                ...
                >
                  <div className="flex justify-between items-start">
                    <img src="/ieee-logo-colour.png" alt="Logo" className="h-10" />
                    <div className="w-10 h-10 rounded-full" style={{ background: BRAND.colors.orange }} />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2" style={{ color: BRAND.colors.navy, leadingTight: 1.1 }}>
                      Annual General Meeting
                    </h3>
                    <p className="text-sm" style={{ color: BRAND.colors.darkGray }}>
                      March 15, 2026 · Kochi, Kerala
                    </p>
                  </div>
                </div>
              </div>
